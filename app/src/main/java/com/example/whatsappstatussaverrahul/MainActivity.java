...
public class MainActivity extends AppCompatActivity {
    ...
    private void setuplayout() {
        ...
        StaggeredGridLayoutManager staggeredGridLayoutManager=new StaggeredGridLayoutManager(SDK_INT,StaggeredGridLayoutManager.VERTICAL);
    ...
    private void checkPermission() {
        ...
        if(SDK_INT>23) {
            ...
            Toast.makeText(getApplicationContext() , text "Already" , Toast.LENGTH_SHORT).show();
             setuplayout();
        }
        }
    }
